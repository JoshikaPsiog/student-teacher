...
export default function Dashboard() {
  ...
  async function handleSave(payload) {
    ...
    try {
      if (editing) {
        console.log('Updating user ID:', editing.id, 'with data:', payload); // Debug
        await updateUser(token, editing.id, payload);  // ✅ Use editing.id
      } else {
  ...
  function handleEdit(user) {
    ...
    setEditing(user);  // ✅ Pass entire user object
    setShowForm(true);
  }
